	...
	<div class="row">
		<div class="col-sm-4 col-md-4">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fiction novels
				...
				<a href="/fictionnovels.jsp"><img src="resources/images/fiction novels.jpg"
		...
		<div class="col-sm-4 col-md-4">
			<div class="thumbnail">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Love novels
				<a href="/lovenovels.jsp"><img src="resources/images/love.jpg"
					alt="Generic placeholder thumbnail"/></a>
			</div>
		</div>
	<div class="col-sm-4 col-md-4">
			<div class="thumbnail">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Comics
				<a href="/comics.jsp"><img src="resources/images/comics.jpg"
					alt="Generic placeholder thumbnail"/></a>
			</div>
		</div>
		</div><!-- End of the thumbnail -->
